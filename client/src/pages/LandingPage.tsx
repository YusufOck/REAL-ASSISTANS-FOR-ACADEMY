          ...
          <div
            className={`relative w-full h-full overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.9)] border border-white/10 bg-black transition-all duration-700 ${
              isMinimized
                ...
                : "rounded-[3rem] max-w-3xl max-h-[70vh]"
            }`}
      ...
      >
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 font-black text-2xl tracking-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200 uppercase tracking-tighter">
              ResearchOS
            </span>
          </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={idx}
                  className="group relative bg-slate-900/40 p-12 rounded-[2rem] border border-white/5 hover:border-purple-500/40 transition-all duration-500 hover:-translate-y-3 shadow-xl overflow-hidden"
                >
                  <div
